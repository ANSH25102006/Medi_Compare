...
export function TrustMetricsBar() {
  ...
  return (
    <div className="relative z-20 mx-auto -mt-10 max-w-7xl px-4 sm:px-6 lg:px-8 animate-fade-in">
      <div className="bg-card rounded-[24px] border border-border p-6 shadow-elevated">
        <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 lg:divide-x lg:divide-border/60">
          {metrics.map((m, idx) => (
            ...
            >
              <span className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-[16px] shadow-sm transition-transform duration-300 ${m.colorClass}`}>
              ...
              <div>
                <div className="flex flex-col">
                  ...
                  <span className="text-xs font-bold text-foreground/80 uppercase tracking-wide mt-1">
                    {m.label}
                  </span>
                </div>
